...
VOLATILE_FORESIGHT = (
    24  # Foresight/Odor Sleuth - removes Ghost immunity to Normal/Fighting
)
...
MOVE_EFFECTS: Dict[str, dict] = {
    ...
    "calmmind": {
        ...
        "stat_changes": [(STAT_SPA, 1, 0), (STAT_SPD, 1, 0)],
    },
    "dragondance": {
        "effect": EFFECT_STAT_CHANGE,
        "stat_changes": [(STAT_ATK, 1, 0), (STAT_SPE, 1, 0)],
    },
    "quiverdance": {
        "effect": EFFECT_STAT_CHANGE,
        "stat_changes": [(STAT_SPA, 1, 0), (STAT_SPD, 1, 0), (STAT_SPE, 1, 0)],
    },
    "shellsmash": {
        "effect": EFFECT_STAT_CHANGE,
        "stat_changes": [
    ...
    "bulkup": {
        "effect": EFFECT_STAT_CHANGE,
        "stat_changes": [(STAT_ATK, 1, 0), (STAT_DEF, 1, 0)],
    },
    ...
    "coil": {
        "effect": EFFECT_STAT_CHANGE,
        "stat_changes": [(STAT_ATK, 1, 0), (STAT_DEF, 1, 0), (STAT_ACC, 1, 0)],
    },
    "workup": {
        "effect": EFFECT_STAT_CHANGE,
        "stat_changes": [(STAT_ATK, 1, 0), (STAT_SPA, 1, 0)],
    },
    ...
    "bellydrum": {
        "effect": EFFECT_STAT_CHANGE,
        "stat_changes": [(STAT_ATK, 12, 0)],
        "recoil": 50,
    },  # Costs 50% HP, +12 to guarantee max
    "curse": {
        "effect": EFFECT_STAT_CHANGE,
        "stat_changes": [(STAT_ATK, 1, 0), (STAT_DEF, 1, 0), (STAT_SPE, -1, 0)],
    },  # Non-ghost
    ...
    "filletaway": {
        "effect": EFFECT_STAT_CHANGE,
        "stat_changes": [(STAT_ATK, 2, 0), (STAT_SPA, 2, 0), (STAT_SPE, 2, 0)],
        "recoil": 50,
    },  # Costs 50% HP
    "honeclaws": {
        "effect": EFFECT_STAT_CHANGE,
        "stat_changes": [(STAT_ATK, 1, 0), (STAT_ACC, 1, 0)],
    },
    "noretreat": {
        "effect": EFFECT_STAT_CHANGE,
        "stat_changes": [
    ...
    "shiftgear": {
        "effect": EFFECT_STAT_CHANGE,
        "stat_changes": [(STAT_SPE, 2, 0), (STAT_ATK, 1, 0)],
    },
    "victorydance": {
        "effect": EFFECT_STAT_CHANGE,
        "stat_changes": [(STAT_ATK, 1, 0), (STAT_DEF, 1, 0), (STAT_SPE, 1, 0)],
    ...
    "geomancy": {
        "effect": EFFECT_STAT_CHANGE,
        "stat_changes": [(STAT_SPA, 2, 0), (STAT_SPD, 2, 0), (STAT_SPE, 2, 0)],
        "flags": ["charge"],
    },  # Needs charge turn
    "stockpile": {
        "effect": EFFECT_STAT_CHANGE,
        "stat_changes": [(STAT_DEF, 1, 0), (STAT_SPD, 1, 0)],
    },
    "cosmicpower": {
        "effect": EFFECT_STAT_CHANGE,
        "stat_changes": [(STAT_DEF, 1, 0), (STAT_SPD, 1, 0)],
    ...
    "charge": {
        "effect": EFFECT_STAT_CHANGE,
        "stat_changes": [(STAT_SPD, 1, 0)],
    },  # Also doubles next Electric move
    "clangoroussoul": {
        "effect": EFFECT_STAT_CHANGE,
        "stat_changes": [
            (STAT_ATK, 1, 0),
    ...
    "lusterpurge": {
        "effect": EFFECT_DAMAGE,
        "stat_changes": [(STAT_SPD, -1, 1)],
        "stat_chance": 50,
    },
    "mistball": {
        "effect": EFFECT_DAMAGE,
        "stat_changes": [(STAT_SPA, -1, 1)],
        "stat_chance": 50,
    },
    # ==========================================================================
    ...
    "nobleroar": {
        "effect": EFFECT_STAT_CHANGE,
        "stat_changes": [(STAT_ATK, -1, 1), (STAT_SPA, -1, 1)],
    },
    ...
    "tickle": {
        "effect": EFFECT_STAT_CHANGE,
        "stat_changes": [(STAT_ATK, -1, 1), (STAT_DEF, -1, 1)],
    },
    "toxicthread": {
        "effect": EFFECT_STAT_CHANGE,
        "stat_changes": [(STAT_SPE, -1, 1)],
        "status": STATUS_POISON,
        "status_chance": 100,
    },
    "spicyextract": {
        "effect": EFFECT_STAT_CHANGE,
        "stat_changes": [(STAT_ATK, 2, 1), (STAT_DEF, -2, 1)],
    },
    "babydolleyes": {
        "effect": EFFECT_STAT_CHANGE,
        "stat_changes": [(STAT_ATK, -1, 1)],
        "priority": 1,
    },
    ...
    "venomdrench": {
        "effect": EFFECT_STAT_CHANGE,
        "stat_changes": [(STAT_ATK, -1, 1), (STAT_SPA, -1, 1), (STAT_SPE, -1, 1)],
    },
    # ==========================================================================
    ...
    "hammerarm": {
        "effect": EFFECT_DAMAGE,
        "stat_changes": [(STAT_SPE, -1, 0)],
        "stat_chance": 100,
    },
    "vcreate": {
        "effect": EFFECT_DAMAGE,
        "stat_changes": [(STAT_DEF, -1, 0), (STAT_SPD, -1, 0), (STAT_SPE, -1, 0)],
        "stat_chance": 100,
    },
    "fleurcannon": {
        "effect": EFFECT_DAMAGE,
    ...
    "alluringvoice": {
        "effect": EFFECT_DAMAGE,
        "volatile": VOLATILE_CONFUSION,
        "volatile_chance": 100,
    },
    "steelwing": {
        "effect": EFFECT_DAMAGE,
        "stat_changes": [(STAT_DEF, 1, 0)],
        "stat_chance": 10,
    },
    "metalclaw": {
        "effect": EFFECT_DAMAGE,
    ...
    "tidyup": {
        "effect": EFFECT_STAT_CHANGE,
        "stat_changes": [(STAT_ATK, 1, 0), (STAT_SPE, 1, 0)],
        "flags": ["removes_hazards", "removes_substitute"],
    },
    # ==========================================================================
    # Weather
    # ==========================================================================
    ...
    "kingsshield": {
        ...
        "priority": 4,
        "flags": ["contact_penalty"],
    },
    "spikyshield": {
        "effect": EFFECT_PROTECT,
        "priority": 4,
        "flags": ["contact_damage"],
    },
    "banefulbunker": {
        "effect": EFFECT_PROTECT,
        "priority": 4,
        "flags": ["contact_poison"],
    },
    "silktrap": {
        "effect": EFFECT_PROTECT,
        "priority": 4,
        "flags": ["contact_speed_drop"],
    },
    "obstruct": {
        "effect": EFFECT_PROTECT,
        "priority": 4,
        "flags": ["contact_def_drop"],
    },
    "burningbulwark": {
        "effect": EFFECT_PROTECT,
        "priority": 4,
    ...
    "moonlight": {
        "effect": EFFECT_RECOVERY,
        "heal": 50,
        "flags": ["weather_dependent"],
    },
    "morningsun": {
        "effect": EFFECT_RECOVERY,
        "heal": 50,
    ...
    "scaleshot": {
        ...
        "hits": (2, 5),
        "stat_changes": [(STAT_SPE, 1, 0), (STAT_DEF, -1, 0)],
        "stat_chance": 100,
    },
    ...
    "firstimpression": {
        "effect": EFFECT_DAMAGE,
        "priority": 2,
        "flags": ["first_turn_only"],
    },
    "grassyglide": {
        "effect": EFFECT_DAMAGE,
        "flags": ["terrain_priority"],
    },  # +1 priority on Grassy Terrain
    # Negative priority
    ...
    "taunt": {
        "effect": EFFECT_NONE,
        "volatile": VOLATILE_TAUNT,
        "volatile_chance": 100,
    },
    "encore": {
        "effect": EFFECT_NONE,
        "volatile": VOLATILE_ENCORE,
        "volatile_chance": 100,
    },
    "disable": {"effect": EFFECT_NONE, "flags": ["disable"]},
    "leechseed": {
        "effect": EFFECT_NONE,
        "volatile": VOLATILE_LEECH_SEED,
        "volatile_chance": 100,
    },
    "substitute": {"effect": EFFECT_SUBSTITUTE},
    "destinybond": {
        "effect": EFFECT_NONE,
        "volatile": VOLATILE_DESTINY_BOND,
        "volatile_chance": 100,
    },
    "perishsong": {
        "effect": EFFECT_NONE,
        "volatile": VOLATILE_PERISH_SONG,
        "volatile_chance": 100,
    },
    # Additional volatile moves
    "focusenergy": {
        "effect": EFFECT_NONE,
        "volatile": VOLATILE_FOCUS_ENERGY,
        "volatile_chance": 100,
    },
    "torment": {
        "effect": EFFECT_NONE,
        "volatile": VOLATILE_TORMENT,
        "volatile_chance": 100,
    },
    "attract": {
        "effect": EFFECT_NONE,
        "volatile": VOLATILE_ATTRACT,
        "volatile_chance": 100,
    },
    "yawn": {"effect": EFFECT_NONE, "volatile": VOLATILE_YAWN, "volatile_chance": 100},
    "embargo": {
        "effect": EFFECT_NONE,
        "volatile": VOLATILE_EMBARGO,
        "volatile_chance": 100,
    },
    "healblock": {
        "effect": EFFECT_NONE,
        "volatile": VOLATILE_HEAL_BLOCK,
        "volatile_chance": 100,
    },
    "imprison": {
        "effect": EFFECT_NONE,
        "volatile": VOLATILE_IMPRISON,
        "volatile_chance": 100,
    },
    "ingrain": {
        "effect": EFFECT_NONE,
        "volatile": VOLATILE_INGRAIN,
        "volatile_chance": 100,
    },
    "aquaring": {
        "effect": EFFECT_NONE,
        "volatile": VOLATILE_AQUA_RING,
        "volatile_chance": 100,
    },
    "nightmare": {
        "effect": EFFECT_NONE,
        "volatile": VOLATILE_NIGHTMARE,
        "volatile_chance": 100,
    },
    "lockon": {
        "effect": EFFECT_NONE,
        "volatile": VOLATILE_LOCK_ON,
        "volatile_chance": 100,
    },
    "mindreader": {
        "effect": EFFECT_NONE,
    ...
    "memento": {
        "effect": EFFECT_STAT_CHANGE,
        "stat_changes": [(STAT_ATK, -2, 1), (STAT_SPA, -2, 1)],
        "flags": ["self_destruct"],
    },
    ...
    "bind": {
        "effect": EFFECT_DAMAGE,
        "volatile": VOLATILE_PARTIAL_TRAP,
        "volatile_chance": 100,
    },
    "wrap": {
        "effect": EFFECT_DAMAGE,
    ...
    "zippyzap": {
        "effect": EFFECT_DAMAGE,
        "stat_changes": [(STAT_EVA, 1, 0)],
        "stat_chance": 100,
        "flags": ["always_crit"],
    },  # +1 evasion, always crits
    "splishysplash": {
        "effect": EFFECT_DAMAGE,
        "status": STATUS_PARALYSIS,
        "status_chance": 30,
    ...
    "bounce": {
        "effect": EFFECT_DAMAGE,
        "flags": ["charge", "semi_invulnerable"],
        "status": STATUS_PARALYSIS,
        "status_chance": 30,
    },
    ...
    "lastrespects": {
        "effect": EFFECT_DAMAGE,
        "flags": ["fainted_scaling"],
    },  # +50 BP per fainted ally
    "ragefist": {
        "effect": EFFECT_DAMAGE,
        "flags": ["hit_scaling"],
    },  # +50 BP per time hit
    "lashout": {
        "effect": EFFECT_DAMAGE,
        "flags": ["stat_lowered_boost"],
    },  # 2x if stats lowered
    "burningjealousy": {
        "effect": EFFECT_DAMAGE,
        "status": STATUS_BURN,
        "status_chance": 100,
        "flags": ["conditional_burn"],
    },
    "strengthsap": {
        "effect": EFFECT_STAT_CHANGE,
        "stat_changes": [(STAT_ATK, -1, 1)],
        "stat_chance": 100,
        "flags": ["heal_by_target_atk"],
    },
    ...
    "shiftgear": {
        "effect": EFFECT_STAT_CHANGE,
        "stat_changes": [(STAT_ATK, 1, 0), (STAT_SPE, 2, 0)],
    },
    "honeclaws": {
        "effect": EFFECT_STAT_CHANGE,
        "stat_changes": [(STAT_ATK, 1, 0), (STAT_ACC, 1, 0)],
...
def get_move_effect(move_name: str) -> dict:
    ...
    return MOVE_EFFECTS.get(
        move_name.lower().replace(" ", "").replace("-", ""), {"effect": EFFECT_DAMAGE}
    )


def create_move_effect_arrays(
    move_to_idx: Dict[str, int], num_moves: int
) -> Tuple[np.ndarray, ...]:
